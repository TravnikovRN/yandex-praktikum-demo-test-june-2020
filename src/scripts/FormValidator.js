...
/** 
 * Надо исправить: при повторном добавлении карточки валидация на "ввод пустой строки" не работает. 
   Одним из вариантом исправления может являться дополнительное условие.
*/
